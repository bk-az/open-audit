...
<br>
' . __('If you need to configure Active Directory access, you can usually use the example of <code>cn=Users,dc=your,dc=domain,dc=com</code> for your <code>base_dn</code>. There is no need to set <code>user_dn</code>.') . '<br>
<br>
' . __('These are only examples. You may need to adjust these attributes to suit your particular LDAP.') . '</p><br>
<h2>' . __('Default Roles Groups') . '</h2>
<table class="table">
    <thead>
        <tr>
            <th>' . __('Name') . '</th>
