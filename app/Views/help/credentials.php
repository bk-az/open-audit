...
<h2>SSH Keys</h2>
<br>
<p>' . __('You should copy and paste the entire file into the textbox. In the case below, copy ALL the text.') . '</p>
<br>
<pre>
