...
foreach ($collections as $collection) {
    if (in_array($collection, ['applications_components', 'baselines_policies', 'baselines_results', 'components', 'database', 'discovery_log', 'integrations_log', 'integrations_rules', 'logs', 'maps', 'news', 'nmis', 'rack_devices', 'sessions', 'support', 'help', 'search', 'errors'])) {
        continue;
    } else {
        $title = $collection;
