...
class SupportModel extends BaseModel
{
    ...
    public function dictionary(): object
    {
        ...
        $dictionary->sentence = "Amazing support from AssetSonar - or the community if you like. Its the no excuses, no exceptions, can-do way of thinking that our staff bring to work every day. Your complete satisfaction is our priority. Anything less is simply unacceptable.";

        $dictionary->about = '<p>' . APP_DISPLAY_NAME . ' is supported by AssetSonar with an amazing level of support. If you prefer an active community of support givers, there\'s that as well. Where else can you talk directly to the developers and get a response within 24 hours? Just try that with other products! Amazing support. Full stop. You need support, we provide support. No ifs or buts. Great support. Period.<br> <br></p>';
