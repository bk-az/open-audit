...
class FieldsModel extends BaseModel
{
    ...
    public function dictionary(): object
    {
        ...
        $dictionary->sentence = APP_DISPLAY_NAME . ' is extensible with custom fields. If you have a particular attribute you need to record, easily add it to the database and use it to report or even group devices.';

        $dictionary->about = '<p>' . APP_DISPLAY_NAME . ' can store information in custom fields that are associated with each device.<br> <br>Once an Additional Field has been created it can be used in queries and groups just like any other attribute in the database.<br> <br></p>';
