...
class ScriptsModel extends BaseModel
{
     ...
     * builder to target the 'scripts' table.
     */
     ...
     *
     * @param  int|null $id    The ID of the script to delete
    ...
    /**
     * Return supplementary data for a single script's read view
     *
     * @param  int   $id The ID of the script whose supplementary data to load
     *
    ...
    /**
     * Return supplementary data for the script create/edit form
     *
     * @param  int   $id The ID of the script whose supplementary data to load
     *
     ...
     *
     * @return array        An array of formatted scripts entries
     */
    ...
    /**
     * Read every script from the database with no org-based filtering
     *
     * Returns all rows from the `scripts` table with no additional filtering.
     * Use {@see listUser()} when results should be restricted to the current user's accessible orgs.
     *
     * @return array  Array of stdClass objects representing every script row
     */
    ...
    /**
     * Truncate the scripts table, removing all rows
     *
     * The $table parameter is accepted for interface compatibility but is
     * ignored; the method always resets the 'scripts' table.
     *
     ...
     *
     * @param  int|null          $id   The ID of the script to update
    ...
    /**
     * Build and return the data dictionary for the scripts collection
     *
     * Constructs a stdClass describing the `scripts` table for use by the
     * framework's help, validation, and API-documentation systems.
     * The returned object includes:
     *  - table       : the collection name ('scripts')
