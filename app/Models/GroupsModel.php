...
class GroupsModel extends BaseModel
{
    ...
    public function dictionary(): object
    {
        ...
        $dictionary->sentence = 'Easily group together devices for simple reporting. ' . APP_DISPLAY_NAME . ' provides more than a dozen groups out of the box and makes it simple to create more.';
