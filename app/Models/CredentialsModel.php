...
class CredentialsModel extends BaseModel
{
     ...
     * builder to target the 'credentials' table.
     */
     ...
     *
     * @param  int|null $id    The ID of the credential to delete
    ...
    /**
     * Return supplementary data for a single credential's read view (stub)
     *
    ...
    /**
     * Return supplementary data for the credential create/edit form (stub)
     *
     * Reserved for future implementation. Currently returns an empty array;
     * no data is fetched from the database.
     *
     ...
     *
     * @return array        An array of formatted credentials entries
     */
    ...
    /**
     * Read every credential from the database with no org-based filtering
     *
     * Returns all rows from the `credentials` table with no additional filtering.
     * Use {@see listUser()} when results should be restricted to the current user's accessible orgs.
     *
     * @return array  Array of stdClass objects representing every credential row
     */
    ...
    /**
     * Truncate the credentials table, removing all rows
     *
     * The $table parameter is accepted for interface compatibility but is
     * ignored; the method always resets the 'credentials' table.
     *
     ...
     *
     * @param  int|null          $id   The ID of the credential to update
    ...
    /**
     * Build and return the data dictionary for the credentials collection
     *
     * Constructs a stdClass describing the `credentials` table for use by the
     * framework's help, validation, and API-documentation systems.
     * The returned object includes:
     *  - table       : the collection name ('credentials')
