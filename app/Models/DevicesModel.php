...
class DevicesModel extends BaseModel
{
     ...
     *
     * @param  int|null $id    The ID of the device to delete
    ...
    /**
     * Return supplementary data for the device collection view
     *
    ...
    /**
     * Return supplementary data for a single device's read view
     *
     * @param  int   $id The ID of the device whose supplementary data to load
     *
    ...
    public function includedRead(int $id = 0): array
    {
        ...
        $include = array();
        $current = array('access_point', 'antivirus', 'bios', 'certificate', 'cli_config', 'disk', 'dns', 'executable', 'file', 'firewall', 'firewall_rule', 'ip', 'license', 'log', 'memory', 'module', 'monitor', 'motherboard', 'netstat', 'network', 'nmap', 'optical', 'pagefile', 'partition', 'policy', 'print_queue', 'processor', 'radio', 'route', 'san', 'scsi', 'server_item', 'service', 'share', 'software', 'software_key', 'sound', 'task', 'usb', 'user', 'user_group', 'variable', 'video', 'vm', 'warranty', 'windows');
        foreach ($current as $table) {
            if (!$this->db->tableExists($table)) {
                continue;
            }
        ...
        if ($this->db->tableExists('arp')) {
            if (empty($resp_include) or in_array('arp', $resp_include)) {
                ...
                $sql = "SELECT arp.*, MAX(arp.vlan_id), ip.device_id AS `ip.device_id` FROM `arp` LEFT JOIN `ip` ON (arp.mac = ip.mac) WHERE arp.device_id = ? and arp.current = 'y' GROUP BY arp.mac";
                $query = $this->db->query($sql, $id);
                $result = $query->getResult();
                if (!empty($result)) {
                    $include['arp'] = $result;
    ...
    /**
     * Return supplementary data for the device create/edit form
     *
     * @param  int   $id The ID of the device whose supplementary data to load
     *
     ...
     *
     * @return array        An array of formatted devices entries
     */
    ...
    /**
     * Read every device from the database with no org-based filtering
     *
     * Returns all rows from the `devices` table with no additional filtering.
     * Use {@see listUser()} when results should be restricted to the current user's accessible orgs.
     *
     * @return array  Array of stdClass objects representing every device row
     */
    ...
    /**
     * Truncate the devices table, removing all rows
     *
     * The $table parameter is accepted for interface compatibility but is
     * ignored; the method always resets the 'devices' table.
     *
    ...
    /**
     * Build and return the data dictionary for the devices collection
     *
     * Constructs a stdClass describing the `devices` table for use by the
     * framework's help, validation, and API-documentation systems.
     * The returned object includes:
     *  - table       : the collection name ('devices')
    ...
    public function dictionary(): object
    {
        ...
        $dictionary->columns->name = 'Derived from hostname, sysName, dns Hostname and IP in that order.';
        $dictionary->columns->org_id = 'Can be set by discovery or user.';
        $dictionary->columns->description = 'Can be set by discovery or user.';
        $dictionary->columns->ip = 'Populated from the IP for the default route or the IP detected in discovery.';
        $dictionary->columns->hostname = 'Populated from the hostname command.';
        $dictionary->columns->dns_hostname = 'Populated from DNS.';
        $dictionary->columns->domain = 'Populated from the hostname command.';
        $dictionary->columns->dns_domain = 'Populated from DNS.';
        $dictionary->columns->dbus_identifier = 'Populated from machine-id on Linux.';
        $dictionary->columns->fqdn = 'Populated from hostname.';
        $dictionary->columns->dns_fqdn = 'Populated from DNS.';
        $dictionary->columns->type = 'Derived from discovery.';
        $dictionary->columns->comments = 'Manually set by user.';
        $dictionary->columns->icon = 'Derived from type or OS.';
        $dictionary->columns->os_group = 'Derived from OS Name.';
        $dictionary->columns->os_family = 'Derived from OS Name.';
        ...
        $dictionary->columns->manufacturer = 'Populated by discovery and audit.';
        $dictionary->columns->manufacturer_code = 'Populated by discovery and audit.';
        $dictionary->columns->service_tag = 'Populated by discovery and audit.';
        $dictionary->columns->model = 'Populated by discovery and audit.';
        $dictionary->columns->serial = 'Populated by discovery and audit.';
        $dictionary->columns->uptime = 'Populated by discovery and audit.';
        $dictionary->columns->form_factor = 'Populated by discovery and audit.';
        $dictionary->columns->os_bit = 'Populated by discovery and audit.';
        $dictionary->columns->os_arch = 'Populated by discovery and audit.';
        $dictionary->columns->os_license = 'Populated by discovery and audit.';
        $dictionary->columns->os_license_code = 'Populated by discovery and audit.';
        $dictionary->columns->os_license_mode = 'Populated by discovery and audit.';
        $dictionary->columns->os_license_type = 'Populated by discovery and audit.';
        $dictionary->columns->os_licence_expiry = 'Populated by discovery and audit.';
        $dictionary->columns->memory_count = 'Populated by discovery and audit.';
        $dictionary->columns->processor_count = 'Populated by discovery and audit.';
        $dictionary->columns->storage_count = 'Populated by discovery and audit.';
        $dictionary->columns->os_installation_date = 'Populated by discovery and audit.';
        $dictionary->columns->printer_port_name = 'Populated by discovery and audit.';
        $dictionary->columns->printer_shared = 'Populated by discovery and audit.';
        $dictionary->columns->printer_shared_name = 'Populated by discovery and audit.';
        $dictionary->columns->printer_color = 'Populated by discovery and audit.';
        $dictionary->columns->printer_duplex = 'Populated by discovery and audit.';
        ...
        $dictionary->columns->location_rack = 'Manually set by user.';
        $dictionary->columns->location_rack_position = 'Manually set by user.';
        $dictionary->columns->location_rack_size = 'Manually set by user.';
        $dictionary->columns->location_latitude = 'Manually set by user.';
        $dictionary->columns->location_longitude = 'Manually set by user.';
        $dictionary->columns->asset_number = 'Manually set by user.';
        $dictionary->columns->asset_tag = 'Derived by audit or manually set by user.';
        $dictionary->columns->vm_server_name = 'Derived by audit.';
        $dictionary->columns->vm_device_id = 'Derived by audit.';
        $dictionary->columns->vm_group = 'Derived by audit.';
        $dictionary->columns->cluster_name = 'Derived by audit or manually set by user.';
        $dictionary->columns->cluster_type = 'Derived by audit or manually set by user.';
        $dictionary->columns->cluster_id = 'Derived by audit or manually set by user.';
        $dictionary->columns->invoice_id = 'Manually set by user.';
        $dictionary->columns->purchase_invoice = 'Manually set by user.';
        $dictionary->columns->purchase_order_number = 'Manually set by user.';
        $dictionary->columns->purchase_cost_center = 'Manually set by user.';
        $dictionary->columns->purchase_vendor = 'Manually set by user.';
        $dictionary->columns->purchase_date = 'Manually set by user.';
        $dictionary->columns->purchase_service_contract_number = 'Manually set by user.';
        $dictionary->columns->lease_expiry_date = 'Manually set by user.';
        $dictionary->columns->purchase_amount = 'Manually set by user.';
        $dictionary->columns->warranty_duration = 'Manually set by user.';
        $dictionary->columns->warranty_expires = 'Manually set by user.';
        $dictionary->columns->warranty_type = 'Manually set by user.';
        $dictionary->columns->warranty_status = 'Manually set by user.';
        $dictionary->columns->maintenance_expires = 'Manually set by user.';
        $dictionary->columns->end_of_life = 'Manually set by user.';
        $dictionary->columns->end_of_service = 'Manually set by user.';
        $dictionary->columns->end_of_production = 'Manually set by user.';
        $dictionary->columns->switch_device_id = 'Manually set by user.';
        $dictionary->columns->switch_port = 'Manually set by user.';
        $dictionary->columns->patch_panel = 'Manually set by user.';
        $dictionary->columns->patch_panel_port = 'Manually set by user.';
        $dictionary->columns->wall_port = 'Manually set by user.';
        $dictionary->columns->contact_name = 'Manually set by user.';
        $dictionary->columns->service_number = 'Manually set by user.';
        $dictionary->columns->service_provider = 'Manually set by user.';
        $dictionary->columns->service_type = 'Manually set by user.';
        $dictionary->columns->service_plan = 'Manually set by user.';
        $dictionary->columns->service_network = 'Manually set by user.';
...
unassigned - The default until set.';
        ...
        $dictionary->columns->sysUpTime = 'Populated from SNMP discovery.';
        $dictionary->columns->sysContact = 'Populated from SNMP discovery.';
        $dictionary->columns->sysName = 'Populated from SNMP discovery.';
        $dictionary->columns->sysLocation = 'Populated from SNMP discovery.';
        ...
        $dictionary->columns->instance_provider = 'Derived from cloud discovery.';
        $dictionary->columns->instance_ident = 'Derived from cloud discovery.';
        $dictionary->columns->instance_type = 'Derived from cloud discovery.';
        $dictionary->columns->instance_state = 'Derived from cloud discovery.';
        $dictionary->columns->instance_reservation_ident = 'Derived from cloud discovery.';
        $dictionary->columns->instance_tags = 'Derived from cloud discovery.';
